...
const [viewportWidth, viewportHeight] = windowWidth / windowHeight < 16 / 9 ? [windowWidth, (windowWidth * 9) / 16] : [(windowHeight * 16) / 9, windowHeight];
...
if (window.innerHeight > window.innerWidth) {
    ...
    if (visual.app.view.style)
        visual.app.view.style['transform'] = 'rotate(90deg)';
